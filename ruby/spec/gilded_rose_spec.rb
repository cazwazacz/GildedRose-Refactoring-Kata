...
describe GildedRose do
  ...
  describe "#update_quality" do
    ...
    it "quality is never negative" do
      ...
      10.times { GildedRose.new(items, ItemSorter, AgedBrie, Sulfuras, BackstagePass, Conjured).update_quality() }
      expect(items[0].quality).to eq 0
    end

    it "quality of Aged Brie increases with time" do
      items = [ItemDouble.new("Aged Brie", 10, 2)]
      5.times { GildedRose.new(items, ItemSorter, AgedBrie, Sulfuras, BackstagePass, Conjured).update_quality() }
